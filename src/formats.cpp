...
extern std::array<DXGI_FORMAT, VK_FORMAT_RANGE_SIZE> formats {
    ...
    DXGI_FORMAT_UNKNOWN, // R8G8B8A8_SINT
    ...
    DXGI_FORMAT_UNKNOWN, // R16G16B16A16_SINT
    ...
    DXGI_FORMAT_UNKNOWN, // D24_UNORM_S8_UINT
    DXGI_FORMAT_UNKNOWN, // D32_SFLOAT_S8_UINT
...
std::array<VkFormatProperties, VK_FORMAT_RANGE_SIZE> formats_property {{
    ...
    { }, // D16_UNORM
    { }, // X8_D24_UNORM_PACK32
    { 0, VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT, 0 }, // D32_SFLOAT
    { }, // S8_UINT
    { }, // D16_UNORM_S8_UINT
    { }, // D24_UNORM_S8_UINT
    { }, // D32_SFLOAT_S8_UINT
